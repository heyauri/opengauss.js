...
class ConnectionParameters {
  constructor(config) {
    ...
    // openGauss
    // The type of the backend database, openGauss / postgres. Default value should be 'openGauss', since this is a openGauss connector library.
    if (config.databaseType === "postgres" || config.databaseType === "pg") {
