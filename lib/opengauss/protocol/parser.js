...
const parseAuthenticationResponse = (reader, length) => {
    ...
    switch (code) {
        ...
        case 10: // AuthenticationSHA256Password // In openGauss, code 10 is auth in sha256 method
            ...
            const passwordStoredMethod = reader.int32();
            const random64code = reader.bytes(64).toString();
            const token = reader.bytes(8).toString();
            // const serverIteration = reader.int32(); // I don't know why it can't get the right value, just hard code it to default, sry.
        ...
        case 11: // AUTH_REQ_MD5_SHA256
            ...
            const md5_random64code = reader.bytes(64).toString();
            const md5Salt = reader.bytes(4);
