...
const ConnectionPostgres = require('./postgres/connection')
// For openGauss 
const ConnectionOpenGauss = require('./opengauss/connection')
const rfc5802 = require('./opengauss/rfc5802')
...
class Client extends EventEmitter {
  constructor(config) {
    ...
    var Connection = this.connectionParameters.databaseType === "openGauss" ? ConnectionOpenGauss : ConnectionPostgres;    
    this.connection =
      c.connection ||
      new Connection({
        stream: c.stream,
