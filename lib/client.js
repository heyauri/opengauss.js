...
const ConnectionPostgre = require('./postgre/connection')
// For openGauss 
...
class Client extends EventEmitter {
  constructor(config) {
    ...
    var Connection = this.connectionParameters.databaseType === "openGauss" ? ConnectionOpenGauss : ConnectionPostgre;
    this.connection =
      c.connection ||
      new Connection({
        stream: c.stream,
